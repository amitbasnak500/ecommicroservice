...
import com.ecommerce.order.exceptions.HTTP400Exception;
import com.ecommerce.order.exceptions.HTTP404Exception;
import com.ecommerce.order.exceptions.RestAPIExceptionInfo;
...
public abstract class AbstractController implements ApplicationEventPublisherAware
{
	...
	protected static final String DEFAULT_PAGE_SIZE = "15";
